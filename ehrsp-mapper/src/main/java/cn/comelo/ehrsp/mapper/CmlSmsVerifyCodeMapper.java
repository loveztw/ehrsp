...
public interface CmlSmsVerifyCodeMapper extends MyMapper<CmlSmsVerifyCode> {
    ...
    @Delete("delete from cml_sms_verify_code  where mobile = #{mobile} and verify_code = #{verifyCode}")
    public void deleteVerifyCodeByMobile(String mobile, String verifyCode);
}